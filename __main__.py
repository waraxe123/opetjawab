...
PM_START_TEXT = """
*ʜᴀɪɪ! {} ᴍʏ ɴᴀᴍᴇ ɪs ᴛᴏᴅᴏʀᴏᴋɪ ʀᴏʙᴏᴛ*
ㅤ
...
buttons = [
    [
        InlineKeyboardButton(text="❓ ɢᴇᴛ ʜᴇʟᴘ", url="http://t.me/jelektapibot?start=help"),
        InlineKeyboardButton(text="💰 ᴅᴏɴᴀᴛᴇ", url="https://t.me/onimaruubot"),
    ],
    [
        InlineKeyboardButton(text="📯 ᴄʜᴀɴɴᴇʟs", url="https://t.me/TodoShotou"),
        InlineKeyboardButton(
            text="🏆 sᴜᴘᴘᴏʀᴛ", url="https://t.me/yahkenatipu"),
...
HELP_STRINGS = """
ᴄʟɪᴄᴋ ᴏɴ ᴛʜᴇ ʙᴜᴛᴛᴏɴ ʙᴇʟʟᴏᴡ ᴛᴏ ɢᴇᴛ ᴅᴇsᴄʀɪᴘᴛɪᴏɴ ᴀʙᴏᴜᴛ sᴘᴇᴄɪꜰɪᴄs ᴄᴏᴍᴍᴀɴᴅ."""


DONATE_STRING = """✨ ᴊɪᴋᴀ ᴋᴀʟɪᴀɴ ᴍᴇɴʏᴜᴋᴀɪ ᴢᴇᴛsᴜ ᴅᴀɴ ɪɴɢɪɴ ʙᴇʀᴅᴏɴᴀsɪ ᴜɴᴛᴜᴋ ᴍᴇᴍʙᴀɴᴛᴜ ᴀɢᴀʀ ᴢᴇᴛsᴜ ᴛᴇᴛᴀᴘ ᴀᴋᴛɪғ ᴛᴇʀᴜs.

• ᴋᴀʟɪᴀɴ ʙɪsᴀ ʙᴇʀᴅᴏɴᴀsɪ ᴅᴇɴɢᴀɴ ᴠɪᴀ ᴅᴀɴᴀ/ᴏᴠᴏ 087845681216 ᴀᴛᴀᴜ ᴋᴀʟɪᴀɴ ʙɪsᴀ ʜᴜʙᴜɴɢɪ ᴏᴡɴᴇʀ ᴅɪʙᴀᴡᴀʜ ɪɴɪ 
    ...
    if update.effective_chat.type == "private":
        if len(args) >= 1:
            if args[0].lower() == "help":
                ...
                send_help(update.effective_chat.id, DONATE_STRINGS)
            ...
            update.effective_message.reply_sticker( 
              "CAACAgUAAx0CZIiVngABBnmVY2j4mfGJRsvBklcJF74i1imCiH0AAq4GAAIjjsFVC6wG-IXP_7krBA", 
           )    
            first_name = update.effective_user.first_name
            uptime = get_readable_time((time.time() - StartTime)) 
            update.effective_message.reply_photo( 
                photo = "https://graph.org/file/ac6ac1890a59ecf742f9f.jpg",
...
def Source_about_callback(update, context):
    ...
    if query.data == "donate_":
        query.message.edit_text(
            text=" ✨ ᴊɪᴋᴀ ᴋᴀʟɪᴀɴ ᴍᴇɴʏᴜᴋᴀɪ ᴢᴇᴛsᴜ ᴅᴀɴ ɪɴɢɪɴ ʙᴇʀᴅᴏɴᴀsɪ ᴜɴᴛᴜᴋ ᴍᴇᴍʙᴀɴᴛᴜ ᴀɢᴀʀ ᴢᴇᴛsᴜ ᴛᴇ."
            "\n • `ᴋᴀʟɪᴀɴ ʙɪsᴀ ʙᴇʀᴅᴏɴᴀsɪ ᴅᴇɴɢᴀɴ ᴠɪᴀ ᴅᴀɴᴀ/ᴏᴠᴏ 087845681216 ᴀᴛᴀᴜᴋᴀʟɪᴀɴʙɪʜᴜʙᴜᴏᴡɴᴇᴅɪʙᴀᴡᴀɪɴ."
            "\n • `ᴅᴀɴ ᴜɴᴛᴜᴋ ʏᴀɴɢ sᴜᴅᴀʜ ʙᴇʀᴅᴏɴᴀsɪ sᴀʏᴀ ᴜᴄᴀᴘᴋᴀɴ ᴛᴇʀɪᴍᴀᴋᴀsɪʜ ʙᴀɴʏᴀᴋ 🙏",
            parse_mode=ParseMode.MARKDOWN,
            disable_web_page_preview=True,
            reply_markup=InlineKeyboardMarkup(
...
def main():
    ...
    source_callback_handler = CallbackQueryHandler(
        Source_about_callback, pattern=r"donate_", run_async=True
    )
